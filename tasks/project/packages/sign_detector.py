...
Everything the agent needs from "perception" lives here — no other files in packages/.
"""
...
# ---------------------------------------------------------------------------
# Sign types + observations (were in sign_types.py)
# ---------------------------------------------------------------------------
class SignType(Enum):
    UNKNOWN = "unknown"
    STOP = "stop"
...
# ---------------------------------------------------------------------------
# Tag ID → sign (were in sign_database.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Detector (were in apriltag_detector.py)
# ---------------------------------------------------------------------------
...
class SignDetector:
    """AprilTag detector — use this name in agent.py."""
...
# Alias if old code used AprilTagDetector
AprilTagDetector = SignDetector
